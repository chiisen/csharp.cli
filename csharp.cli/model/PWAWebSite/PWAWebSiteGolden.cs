...
namespace csharp.cli.model
{
    ...
    /// Golden 遊戲清單
    /// </summary>
    public class PWAWebSiteGolden : PWAWebSite
    {
        /// <summary>
        /// ServerId
        /// </summary>
        ...
        {
            return (PWAWebSiteGolden)this.MemberwiseClone();
        }
        public string Replace(string values, PWAWebSite item)
        {
            ...
            /*
             {
                ...
                "mType": 0,
                "imagePath": "Gold",
                "imageName": "slotsgameicon01",
                "active": true,
                "localizationCode": "Game_Golden_slotsgameicon01",
                "categoryIdList": [
                  1,
                  4
                ],
             ...
             */
            // 查 "PWAWebSiteClub2" Golden 是 3 - 1:真人, 3:電子, 4:體育, 5:棋牌, 6:彩票, 7:動競, 8:電競
