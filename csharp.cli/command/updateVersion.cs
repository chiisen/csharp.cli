...
public partial class Program
{
    /// <summary>
    /// 更新版本號
    /// 命令列引數: update-version "C:/royal/adminapi_core5/AdminAPI_Core5/StaticFile/json/PWAWebSiteDataVersion.K8SDEV.json"
    /// </summary>
    public static void updateVersion()
    {
        _ = App.Command("update-version", command =>
        {
            // 第二層 Help 的標題
            command.Description = "update-version 說明";
            ...
            command.OnExecute(() =>
            {
                Console.WriteLine($"update-version", Color.Azure);
