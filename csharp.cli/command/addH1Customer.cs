...
public partial class Program
{
    ...
    /// 腳本參考: https://hackmd.io/@chiisen/BkeagjBs0
    ...
    /// </summary>
    public static void addH1Customer()
    {
        _ = App.Command("add-h1customer", command =>
        {
            // 第二層 Help 的標題
            command.Description = "add-h1customer 說明";
            ...
            command.OnExecute(() =>
            {
                Console.WriteLine($"add-h1customer", Color.Azure);
                ...
                const string redisKey = "add-h1customer";
