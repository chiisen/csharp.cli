...
namespace csharp.cli.model
{
    ...
    /// MP 遊戲清單
    /// </summary>
    public class PWAWebSiteMP : PWAWebSite
    {
        /// <summary>
        /// ServerId
        /// </summary>
        ...
        {
            return (PWAWebSiteMP)this.MemberwiseClone();
        }
            ...
            /*
             {
                ...
                "imageName": "180",
                "active": true,
                "localizationCode": "Game_MP_180",
                "categoryIdList": [ 1 ],
                "GameCode": "180",
                "sort": 1
              },
             */
            // 查 "PWAWebSiteClub2" MP 是 5 - 1:真人, 3:電子, 4:體育, 5:棋牌, 6:彩票, 7:動競, 8:電競
